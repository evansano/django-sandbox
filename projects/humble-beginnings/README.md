...
$ # Create view function in <site_root>/mysite/polls/views.py
$ # Include polls app in <site_root>/mysite/urls.py
$ # Add polls.apps.PollsConfig to <site_root>/mysite/settings.py
```
...
$ # After adding the database models in <site_root>/mysite/polls/models.py
$ python manage.py makemigrations polls
$ # View but do not apply generated migrations
$ python manage.py sqlmigrate polls 0001
```

## Interact with database using python django API
```
$ cd site
